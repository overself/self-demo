package com.wenjay.demo.app1.controller;
...
@Slf4j
@RestController
@RequestMapping(value = {"api/app1/common"})
public class CommonController {
    ...
    @Autowired
    private RemoteApp2Service app2Service;
    ...
    public Result<Map<String, Object>> testFeignAppName(@PathVariable("id") Integer id) {
        Result<Map<String, Object>> result = app2Service.getAppName(id);
